function round(value: number, step: any) {
    step || (step = 1.0);
    var inv = 1.0 / step;
    return Math.round(value * inv) / inv;
}

function currencyToNumber(n: number | number[] | string | string[], currency: boolean = false): number | string {
...
function numberToCurrency(n: number | number[] | string | string[], currency: boolean = false) {
...
export { round, currencyToNumber, numberToCurrency };